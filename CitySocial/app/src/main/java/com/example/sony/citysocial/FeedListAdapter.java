...
public class FeedListAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public FeedListAdapter(Activity activity, List<FeedItem> feedItems) {
        try{
            ...
            Log.e("Point8", "flag");
            Log.e("Point3", imageLoader.toString());
        }
        catch(Exception e){Log.e("Pi", "msg");}
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       // morebutton = (ImageButton) convertView.findViewById(R.id.btnMore);

       // morebutton.setOnClickListener((View.OnClickListener) this);
